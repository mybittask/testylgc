...
- Minor fixes:
  - s/Bitcoin/logicrypt/ in the Coin Control example
...
- Internal miner added back to logicrypt.  setgenerate now works, although it is generally a bad idea as it is significantly slower than external CPU miners.
